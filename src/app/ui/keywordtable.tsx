        ...
        <>
            <div className='mx-28'>
                ...
                <div className='grid grid-cols-3 grid-rows-3 gap-4 flex-shrink-0 justify-items-center content-evenly items-center'>
                    ...
                    {results.map((books) => (
                    <div key={books.book_number} className='border-solid border-4 bg-zinc-100 border-gray-200 text-gray-700 rounded-[35px] text-ellipsis overflow-hidden size-80'>
